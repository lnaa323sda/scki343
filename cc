...
--------------------------------------------------------------------------------------------------------
local HomePage = a:Tab("Tab Information")
local Settings = a:Tab("Tab Settings Farming")
local Main = a:Tab("Tab General")
local M = a:Tab("Tab Item & Quest")
local Ss = a:Tab("Tab Stats")
local RaceV4 = a:Tab("Tab Race V4")
local EventGame = a:Tab("Tab Game Event")
local P = a:Tab("Tab Local Player")
local Status = a:Tab("Tab Status Sever")
local Visual = a:Tab("Tab Visual")
local R = a:Tab("Tab Dungeon")
local T = a:Tab("Tab Teleport")
local S = a:Tab("Tab Shop")
local D = a:Tab("Tab Devil Fruit")
local Misc = a:Tab("Tab Miscellaneous")

HomePage:Seperator("Apple Hub")

HomePage:Label("Blox Fruits | Script Free Version")
...
--------------------------------------------------------------------------------------------------------
TienTiny:Seperator("x2N HUB")
TienTiny:UserMinhTien()
local Creator = TienTiny:Label('Hii '..game.Players.LocalPlayer.Name.." To x2N HUB !! Thanks Using.")
...
TienTiny:Seperator("🧑‍💻 Developer 🧑‍💻")
TienTiny:Label("Owner: Nguyen Minh Tien (Tien Tiny)")
TienTiny:Seperator("Social Network")
TienTiny:Button('Discord Sever', function()
setclipboard(_G.Discord)
end)
TienTiny:Button('YouTube Official', function()
setclipboard(_G.YouTube)
end)
TienTiny:Button('Tik Tok Official', function()
setclipboard(_G.TikTok)
end)
--------------------------------------------------------------------------------------------------------
Settings:Seperator("Settings Farming")

Settings:Toggle("Auto SetSpawn Point",true,function(value)
    _G.Set = value
end)
...
Settings:Dropdown("Select Weapon",WeaponList,function(value)
...
FarmMode = "Normal"
Settings:Dropdown("Select Farm Mode", ListF,function(value)
    FarmMode = value
end)

Settings:Toggle("Bypass TP",BypassTP,function(Fast)
BypassTP = Fast
end)
...
_G.BringMode = "Normal"
Settings:Dropdown("Bring Mob Mode", Bring,function(value)
    _G.BringMode = value
end)
spawn(function()
    while wait(.1) do
...
Settings:Dropdown("Fast Attack Delay", AttackList,function(SimpRose)
...
Settings:Toggle("Auto Click",true,function(value)
_G.AutoClick = value
end)

Settings:Toggle("Disabled Notifications Text",function(TienTiny)
...
Settings:Toggle("Remove Hit Sound And Level Up",function(Remo)
_G.RemoveHit = Remo
end)
...
Settings:Toggle("Disabled Damage",function(Remo)
...
Settings:Toggle("Black Screen",function(Umm)
...
elseif _G.WhiteScreen == false then
    ...
    Settings:Toggle("Invisible Monsters",_G.inv,function(value)
    _G.inv = value
    ...
    Settings:Seperator("Setting Farm Mode")

    Settings:Label("Distance X Right Vector")
    Settings:Label("Distance Y Up Vector")
    Settings:Label("Distance Z Behind Vector")

    PosY = 35
    Settings:Slider("Pos Y Distance Farm ",0,50,35,function(value)
    PosY = value
    end)

    Settings:Seperator("Misc Setting Mastery")
    
    _G.Kill_At = 25
    Settings:Slider("Kill At %",1,100,25,function(value)
        _G.Kill_At = value
    end)
...
Main:Toggle("Auto Kaitun",function(value)
       _G.AutoFarm = value
...
Main:Toggle("Auto Farm Chest",function(value)
 AutoFarmChest = value
...
Main:Toggle("Auto Farm Chest Mirage island",function(value)
...
Main:Toggle("Auto Chest Bypass",function(vu)
	_G.ChestBypass = vu
end)
...
spawn(function()
    ...
    Main:Toggle("Auto Spawn Cake Prince",function(value)
...
M:Toggle("Auto Mystic Island",_G.AutoMysticIsland,function(value)
    ...
    while wait() do
		pcall(function()
			if AutoW then
				game:service('VirtualInputManager'):SendKeyEvent(true, "W",  game)
				wait(0.35)
				game:service('VirtualInputManager'):SendKeyEvent( "W",  game)
				wait(1.5)
				game:service('VirtualInputManager'):SendKeyEvent(true, "S",  game)
				wait(0.35)
				game:service('VirtualInputManager'):SendKeyEvent( "S",  game)
				wait(1.5)
			end
		end)
    end
...
if World2 then
M:Toggle("Auto Farm Radioactive Material",function(value)
Radioactive = value
...
if World2 then  
M:Toggle("Auto Farm Mystic Droplet",function(value)
_G.Makori_gay = value
...
if World1 or world2 or World3 then    
M:Toggle("Auto Farm Scrap Metal",function(value)
Scrap = value
StopTween(Scrap)
end)
...
if World3 then  
M:Toggle("Auto Farm Conjured Cocoa",function(value)
Cocoafarm = value
StopTween(Cocoafarm)
end)
...
if World3 then     
M:Toggle("Auto Farm Dragon Scale",function(value)
Dragon_Scale = value
...
if World3 then    
M:Toggle("Auto Farm Gunpowder",function(value)
Gunpowder = value
StopTween(Gunpowder)
end)
...
if World3 then     
M:Toggle("Auto Farm Fish Tail World 3",function(value)
Fish = value
StopTween(Fish)
end)
...
if World3 then  
M:Toggle("Auto Farm Mini Tusk",function(value)
MiniHee = value
StopTween(MiniHee)
end)
                    ...
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        ...
                        if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon-Dragon") then                      
                            if _G.SkillZ then
                                ...
                                game:GetService("VirtualInputManager"):SendKeyEvent(true,"Z",game)
                                game:GetService("VirtualInputManager"):SendKeyEvent("Z",game)
                            end
                            if _G.SkillX then          
                                local args = {
                                    [1] = PosMonMasteryFruit.Position
                                ...
                                game:GetService("Players").LocalPlayer.Character[game:GetService("Players").LocalPlayer.Character:FindFirstChildOfClass("Tool").Name].RemoteEvent:FireServer(unpack(args))               
                                game:GetService("VirtualInputManager"):SendKeyEvent(true,"X",game)
                                game:GetService("VirtualInputManager"):SendKeyEvent("X",game)
                            end
                            if _G.SkillC then
                                local args = {
                                    [1] = PosMonMasteryFruit.Position
                                ...
                                game:GetService("Players").LocalPlayer.Character[game:GetService("Players").LocalPlayer.Character:FindFirstChildOfClass("Tool").Name].RemoteEvent:FireServer(unpack(args))                          
                                game:GetService("VirtualInputManager"):SendKeyEvent(true,"C",game)
                                wait(2)
                                game:GetService("VirtualInputManager"):SendKeyEvent("C",game)
                            end
                        ...
                        elseif game:GetService("Players").LocalPlayer.Character:FindFirstChild("Human-Human: Buddha") then
                            ...
                            if _G.SkillV then
                                ...
                                game:GetService("Players").LocalPlayer.Character[game:GetService("Players").LocalPlayer.Character:FindFirstChildOfClass("Tool").Name].RemoteEvent:FireServer(unpack(args))
                                game:GetService("VirtualInputManager"):SendKeyEvent(true,"V",game)
                                game:GetService("VirtualInputManager"):SendKeyEvent("V",game)
                            end
...
M:Toggle("Auto Soul Guitar + Hop",function(value)
                    ...
                    elseif GetMaterial("Alucard Fragment") == 6 then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Cursed Skeleton Boss [Lv. 2025] [Boss]") or game:GetService("Workspace").ReplicatedStorage:FindFirstChild("Cursed Skeleton Boss [Lv. 2025] [Boss]") then
                            ...
                            if (CFrame.new(-12361.7060546875, 603.3547973632812, -6550.5341796875).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 100 then
                                ...
                                wait(1.5)
                                game:GetService("VirtualInputManager"):SendKeyEvent(true, "E",  game)
                                wait(1.5)
...
function EquipAllWeapon()
    ...
    M:Toggle('Teleport to Seabaeat',  function(value)
...
spawn(function()
    while wait() do
        pcall(function()
            if AutoSkill then
                if Skillz then
                    game:service('VirtualInputManager'):SendKeyEvent(true, "Z",  game)
                    wait(.1)
                    game:service('VirtualInputManager'):SendKeyEvent( "Z",  game)
                end
                if Skillx then
                    game:service('VirtualInputManager'):SendKeyEvent(true, "X",  game)
                    wait(.1)
                    game:service('VirtualInputManager'):SendKeyEvent( "X",  game)
                end
                if Skillc then
                    game:service('VirtualInputManager'):SendKeyEvent(true, "C",  game)
                    wait(.1)
                    game:service('VirtualInputManager'):SendKeyEvent( "C",  game)
                end
                if Skillv then
                    game:service('VirtualInputManager'):SendKeyEvent(true, "V",  game)
                    wait(.1)
                    game:service('VirtualInputManager'):SendKeyEvent( "V",  game)
                end
            end
        end)
    end
...
M:Toggle('Ennable Hop Sea Event Farm',  function(value)
...
Ss:Toggle("Melee",function(Value)
melee = Value    
end)
Ss:Toggle("Defense",function(value)
defense = value
end)
Ss:Toggle("Sword",function(value)
sword = value
end)
Ss:Toggle("Gun",function(value)
gun = value
end)
Ss:Toggle("Devil Fruit",function(value)
demonfruit = value
end)
...
--------------------------------------------------------------------------------------------------------
    if World1 or World2 then
RaceV4:Label("Pls Go To The Third Sea🤓")
end
...
RaceV4:Toggle("Disabled Inf Stairs", nil, function(value)
  ...
  RaceV4:Button("Teleport Trial Door",function()
    Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
    wait(.1)
    Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
    wait(.1)
  ...
  RaceV4:Toggle("Trial All Race V4",function(v)
  _G.AutoQuestRace = v
				...
				elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Fishman" then
					for i,v in pairs(game:GetService("Workspace").SeaBeasts.SeaBeast1:GetDescendants()) do
						if v.Name ==  "HumanoidRootPart" then
							...
							game:GetService("VirtualInputManager"):SendKeyEvent(true,122,game.Players.LocalPlayer.Character.HumanoidRootPart)
							game:GetService("VirtualInputManager"):SendKeyEvent(122,game.Players.LocalPlayer.Character.HumanoidRootPart)
							wait(.2)
							game:GetService("VirtualInputManager"):SendKeyEvent(true,120,game.Players.LocalPlayer.Character.HumanoidRootPart)
							game:GetService("VirtualInputManager"):SendKeyEvent(120,game.Players.LocalPlayer.Character.HumanoidRootPart)
							wait(.2)
							game:GetService("VirtualInputManager"):SendKeyEvent(true,99,game.Players.LocalPlayer.Character.HumanoidRootPart)
							game:GetService("VirtualInputManager"):SendKeyEvent(99,game.Players.LocalPlayer.Character.HumanoidRootPart)
							for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
								if v:IsA("Tool") then
...
RaceV4:Toggle("Auto Lock Moon",_G.LockCamToMoon,function(value)
...
RaceV4:Toggle("Kill Player After Trial!",function(value)
...
--------------------------------------------------------------------------------------------------------
EventGame:Seperator("Rough Sea")
    
    EventGame:Toggle("Auto Drive Boat", _G.AppleAutoDriveBoat,function(value)
    ...
    EventGame:Toggle("Auto Farm Terrorshark", _G.AutoTerrorshark,function(value)
         _G.AutoTerrorshark = value
        StopTween( _G.AutoTerrorshark)
    end)
    
    EventGame:Toggle("Auto Farm Shark",FarmTFully,function(value)
    FarmShark = value
    StopTween(FarmShark)
    end)
    ...
    EventGame:Toggle("Auto Farm Piranha",_G.farmpiranya,function(value)
    _G.farmpiranya = value
    StopTween(_G.farmpiranya)
    end)
    
    EventGame:Toggle("Auto Fish Crew Member",_G.Fish_Crew_Member,function(value)
    _G.Fish_Crew_Member = value
    StopTween(_G.Fish_Crew_Member)
    end)
    
    EventGame:Toggle("Auto Terrorshark Hop", _G.AutoTerrorsharkhop,function(value)
    ...
    EventGame:Toggle("Auto Raid Ship",_G.KillGhostShip,function(value)
        ...
        if _G.KillGhostShip then
            pcall(function()
                if CheckPirateBoat() then
                    game:GetService("VirtualInputManager"):SendKeyEvent(true,32,game)
                    wait(.5)
                    game:GetService("VirtualInputManager"):SendKeyEvent(32,game)
    ...
    EventGame:Toggle("Auto Ghost Ship",_G.bjirFishBoat,function(value)
...
spawn(function()
            ...
            if _G.bjirFishBoat then
                   pcall(function()
						if CheckPirateBoat() then
							...
							game:GetService("VirtualInputManager"):SendKeyEvent(99,game.Players.LocalPlayer.Character.HumanoidRootPart)
							wait(.2)
							game:GetService("VirtualInputManager"):SendKeyEvent("C",game.Players.LocalPlayer.Character.HumanoidRootPart)
							for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
								if v:IsA("Tool") then
									if v.ToolTip == "Blox Fruit" then -- "Blox Fruit" , "Sword" , "Wear" , "Agility"
										game.Players.LocalPlayer.Character.Humanoid:EquipTool(v)
							...
							game:GetService("VirtualInputManager"):SendKeyEvent(99,game.Players.LocalPlayer.Character.HumanoidRootPart)
							wait(.2)
					        game:GetService("VirtualInputManager"):SendKeyEvent(true,"V",game.Players.LocalPlayer.Character.HumanoidRootPart)
                            game:GetService("VirtualInputManager"):SendKeyEvent("V",game.Players.LocalPlayer.Character.HumanoidRootPart)
							wait(0.6)
							for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
								if v:IsA("Tool") then
									if v.ToolTip == "Sword" then -- "Blox Fruit" , "Sword" , "Wear" , "Agility"
    ...
    EventGame:Toggle("Auto Frozen Dimension",_G.AutoFrozenDimension,function(value)
    _G.AutoFrozenDimension = value
    StopTween(_G.AutoFrozenDimension)
    end)
    
    EventGame:Seperator("Kitsune Event")
    
    EventGame:Toggle("Auto Kitsunen Island",_G.AutoFKitsune,function(value)
...
EventGame:Toggle("Teleporter Kitsune",  function(value)
    _G.tpkit = value
    StopTween(_G.tpkit)
end)
...
EventGame:Toggle("Auto Collect Azure Ember",  function(value)
    _G.lumlinhhon = value
...
EventGame:Button("Teleport Azure Ember",function()
...
EventGame:Button("Trade Azure Ember",function()
game:GetService("ReplicatedStorage"):WaitForChild("Modules"):WaitForChild("Net"):WaitForChild("RF/KitsuneStatuePray"):InvokeServer()
 end)
--------------------------------------------------------------------------------------------------------
Visual:Seperator("ESP MENU")
Visual:Toggle("ESP Island Kitsune",function(value)
        IslandESP = value
...
Visual:Toggle("ESP Player",function(a)
        ESPPlayer = a
	UpdatePlayerChams()
    end)
    
    Visual:Toggle("ESP Chest",function(a)
        ChestESP = a
	UpdateChestChams() 
    end)
    
    Visual:Toggle("ESP Fruit",function(a)
        DevilFruitESP = a
    ...
    Visual:Toggle("ESP Real Fruit",RealFruitESP,function(a)
        RealFruitESP = a
	UpdateRealFruitChams() 
    end)
    
    Visual:Toggle("ESP Flower",function(a)
        FlowerESP = a
	UpdateFlowerChams() 
    end)
    spawn(function()
...
Visual:Toggle("ESP Island",IslandESP,function(value)
        IslandESP = value
        while IslandESP do wait()
            UpdateIslandESP() 
        end
    end)
    Visual:Toggle("Esp Npc",  function(nec)
    NpcESP = nec
end)

Visual:Toggle("Esp Sea Beast",  function(nec)
    SeaESP = nec
end)


Visual:Toggle("Esp Mob",  function(nec)
    MobESP = nec
end)

Visual:Toggle("Esp Mystic Island",  function(value)
...
Visual:Toggle("Esp Advanced Fruit Dealer",  function(value)
    AfdESP = value
...
Visual:Toggle("Esp Gear",  function(value)
    GearESP = value
...
Visual:Seperator("Troll")
Visual:Button('Rain Fruit', function()
...
Visual:Button('Instant Level/Beli/EXP', function()
...
Visual:Button("Fishman Fake Transform",function()
...
Visual:Button("Skypeian Fake Transform",function()
...
Visual:Button("Ghoul Fake Transform",function()
...
Visual:Button("Cyborg Fake Transform",function()
...
Visual:Button("Human Fake Transform",function()
...
Visual:Button("Fake Mink Dash Animation",function()
 local ReplicatedStorage = game:GetService("ReplicatedStorage")
...
Visual:Seperator("Highlight")

Visual:Toggle("Show Chat disabled", _G.chat, function(value)
    _G.chat = value
...
StarterGui:SetCoreGuiEnabled(Enum.CoreGuiType.Chat, true)    
  ...
  Visual:Toggle("Show leaderboard disabled", _G.leaderboard, function(a)
    _G.leaderboard = a
...
game:GetService('StarterGui'):SetCoreGuiEnabled(Enum.CoreGuiType.PlayerList, true)   
    ...
    Visual:Toggle("Highlight Mode",function(value)
        if value == true then
...
Visual:Toggle("Graphic",function(v)
			if v then
	...
	Visual:Toggle("Xray",function(value)
		NoWorld = value
	...
	Visual:Toggle("Rainbow Haki",function(value)
		RainbowHaki = value
	end)

	Visual:Toggle("Rainbow Yoru",function(value)
		RainbowYoru = value
	end)
...
Visual:Line()
    ...
    Visual:Seperator("Hack")
    Visual:Button("Unlock Buso",function()
    
local Ability = "Buso"
-- local Ability = {Buso,Soru,Geppo}
if type(Ability) == 'string' then
   game:GetService("CollectionService"):Tag(game.Players.LocalPlayer.Character,Ability)
elseif type(Ability) == 'table' then
   for i,v in next , Ability do
       game:GetService("CollectionService"):Tag(game.Players.LocalPlayer.Character,v)
   end
   end
   end)
   
   Visual:Button("Unlock Soru",function()
...
elseif type(Ability) == 'table' then
   ...
   Visual:Button("Unlock Geppo",function()
...
elseif type(Ability) == 'table' then
   for i,v in next , Ability do
    ...
    Visual:Button("Unlock Portal",function()
    ...
    Visual:Button("Max Zoom", function()
		while wait() do
			game.Players.LocalPlayer.CameraMaxZoomDistance = 9223372036854718
			end
	end)
	
Visual:Button("Buddha Big", function()
local LocalPlayer = game:GetService("Players").LocalPlayer
...
Visual:Button("Kaitun Cap", function(value)
    ...
    Visual:Button("Invisible",function()
        game:GetService("Players").LocalPlayer.Character.LowerTorso:Destroy()
    end)
    
    Visual:Button("Click TP Tool",function()
        local plr = game:GetService("Players").LocalPlayer
...
Visual:Seperator("Graphic")

    
    Visual:Button("FPS Boost",function()
        pcall(function()
    ...
    Visual:Button("Remove Fog (New)",function(qww)
	game:GetService("Lighting").LightingLayers:Destroy()
	game:GetService("Lighting").Sky:Destroy()
end)
    
Visual:Toggle("Remove Fog",RemoveFog,function(value)
    RemoveFog = value
    ...
    Visual:Button("Always Day",function()
    game:GetService("RunService").Heartbeat:wait() do
        game:GetService("Lighting").ClockTime = 12
    end
    end)
    
    Visual:Toggle("Remove Damage",function()
    ...
    Visual:Button("Unlock FPS",function()
        setfpscap(9999999)
    end)
    
    Visual:Button("Reduce Cpu", function()
	...
	for i, e in pairs(l:GetChildren()) do
     ...
     Visual:Button("Fake Skin MODE™",function()
	 spawn(function()
     pcall(function()
     while true do
     wait(.0)
    ...
    Visual:Seperator("Abilities")
    
    Visual:Toggle("Dodge No Cooldown",function(value)
        nododgecool = value
        NoDodgeCool()
    end)
    
    Visual:Toggle("Infinite Energy",function(value)
        InfiniteEnergy = value
        originalstam = LocalPlayer.Character.Energy.Value
    end)
    
    Visual:Toggle("Auto Active Race",_G.AutoAgility,function(value)
    ...
    Visual:Toggle("Infinite Ability",true,function(value)
        InfAbility = value
        if value == false then
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility"):Destroy()
        end
    ...
    Visual:Toggle("Auto Use Awakening",_G.AutoAwakeningRace,function(value)
    ...
    while wait() do
		pcall(function()
			if _G.AutoAwakeningRace then
				game:GetService("VirtualInputManager"):SendKeyEvent(true,"Y",game)
				wait(0.1)
                game:GetService("VirtualInputManager"):SendKeyEvent("Y",game)
			end
		end)
    end
    end)
    
    Visual:Toggle("Infinite Obversation Range",getgenv().InfiniteObRange,function(value)
    ...
    Visual:Toggle("Infinite Geppo",getgenv().InfGeppo,function(value)
    ...
    Visual:Toggle("Infinite Soru",getgenv().InfSoru,function(value)
    ...
    Visual:Toggle("Walk on Water",true,function(value)
        _G.WalkWater = value
    end)
    ...
    Visual:Toggle("NoClip",_G.NOCLIP,function(value)
        _G.NOCLIP = value
    end)
    ...
    Visual:Button("Remove Lava",function()
		for i,v in pairs(game.Workspace:GetDescendants()) do
			if v.Name == "Lava" then   
				v:Destroy()
			end
...
--------------------------------------------------------------------------------------------------------
    ...
    P:Toggle("Spectate Player",function(value)
        SpectatePlys = value
    ...
    P:Toggle("Teleport",function(value)
    ...
    P:Toggle("Teleport Player Bypass",function(bool)
                                    _G.Teleport = bool
    ...
    P:Toggle("Auto Farm Player",function(value)
...
P:Toggle("Spectate Boats",function(bool)
  Sp = bool
  ...
  game.Workspace.Camera.CameraSubject = game.Players.LocalPlayer.Character.Humanoid
    ...
    P:Toggle("Aimbot Gun",function(value)
        _G.Aimbot_Gun = value
    end)
    ...
    P:Toggle("Aimbot Skill Nearest",function(MakoriGG)
...
spawn(function()
    ...
    P:Toggle("Aimbot Skill",function(value)
    ...
    P:Toggle("Enabled PvP",function(value)
        _G.EnabledPvP = value
    end)
...
P:Button("Set Position Spawn",function()
    ...
    P:Toggle("Safe Mode",function(value)
        _G.Safe_Mode = value
    ...
    P:Toggle("Start Bounty Lock",function(value)
...
--------------------------------------------------------------------------------------------------------
Status:Seperator("Status Game")
Time = Status:Label("Executer Time")
...
Status:Label("Exploit Using: ".. identifyexecutor())

Status:Seperator("Status Sever")
Status:Seperator("Status Elite")
local EliteProgress = Status:Label("N/A")
    ...
    local Elite_Hunter_Status = Status:Label("N/A")
...
Status:Seperator("Status Kitsune")
local TienTiny = Status:Label("N/A")
task.spawn(function()
	while task.wait() do
		pcall(function()
...
Status:Seperator("Status Mirage")
spawn(function()
        pcall(function()
            while wait() do
...
Mirragecheck = Status:Label("N/A")
Status:Seperator("Status Moon")
local FM = Status:Label('Wait For Moon...')
...
Status:Seperator("Status Frozen")
spawn(function()
    pcall(function()
        while wait() do
            if game.Workspace._WorldOrigin.Locations:FindFirstChild('Frozen Dimension') then
...
FrozenIsland = Status:Label("N/A")

Status:Seperator("Status Bone")
BoneCheck = Status:Label("Total Bone: N/A")
...
Status:Seperator("Status Observation") 
local ObservationRange = Status:Label("Observation Range Level: N/A")
...
Status:Seperator("Status Legend Swords")
...
LegendSwords = Status:Label("N/A")
Status:Seperator("Status Haki Dealer")
spawn(function()
    pcall(function()
        while wait() do
...
ColorHaki = Status:Label("N/A")

Status:Seperator("Status Player")
    
    local locallv = Status:Label("Level")
    ...
    local localrace = Status:Label("Race")
    ...
    local localbeli = Status:Label("Beli")
    ...
    local localfrag = Status:Label("Fragment")
    ...
    local localexp = Status:Label("ExP")
    ...
    local localstat = Status:Label("Stats Points")
    ...
    local localbountyhornor = Status:Label("Bounty")
    ...
    local localDevil = Status:Label("Devil Fruit")
...
Status:Seperator(" Sword ")

local Saber = Status:Label("❌: Saber")
local Rengoku = Status:Label("❌: Rengoku")
local Midnight_Blade = Status:Label("❌: Midnight Blade")
local Dragon_Trident = Status:Label("❌: Dragon Trident")
local Yama = Status:Label("❌: Yama")
local Buddy_Sword = Status:Label("❌: Buddy Sword")
local Canvander = Status:Label("❌: Canvander")
local Twin_Hooks = Status:Label("❌: Twin Hooks")
local Spikey_Trident = Status:Label("❌: Spikey Trident")
local Hallow_Scythe = Status:Label("❌: Hallow Scythe")
local Dark_Dagger = Status:Label("❌: Dark Dagger")
local Tushita = Status:Label("❌: Tushita")
...
Status:Seperator("Quest")

local Bartilo_Quest = Status:Label("❌: Bartilo Quest")
local Don_Swan_Quest = Status:Label("❌: Don Swan Quest")
local Kill_Don_Swan = Status:Label("❌: Kill Don Swan")
...
Status:Seperator("Sword Legendary")

local Shisui = Status:Label("❌: Shisui")
local Saddi = Status:Label("❌: Saddi")
local Wando = Status:Label("❌: Wando")
local True_Triple_Katana = Status:Label("❌: True Triple Katana")
...
Status:Seperator("Melee")

local Superhuman = Status:Label("❌: Superhuman")
local Death_Step = Status:Label("❌: Death Step")
local Sharkman_Karate = Status:Label("❌: Sharkman Karate")
local Electric_Claw = Status:Label("❌: Electric Claw")
local Dragon_Talon = Status:Label("❌: Dragon Talon")
local God_Human = Status:Label("❌: God Human")
...
Status:Seperator("Gun")

local Kabu_cha = Status:Label("❌: Kabucha")
local Acidum_Rifle = Status:Label("❌: Acidum Rifle")
local Bizarre_Rifle = Status:Label("❌: Bizarre Rifle")
...
Status:Seperator("Accessory")

local Dark_Coat = Status:Label("❌: Dark Coat")
local Ghoul_Mask = Status:Label("❌: Ghoul Mask")
local Swan_Glass = Status:Label("❌: Swan Glass")
local Pale_Scarf = Status:Label("❌: Pale Scarf")
local Valkyrie_Helm = Status:Label("❌: Valkyrie Helm")
...
--------------------------------------------------------------------------------------------------------
    ...
    T:Toggle("Teleport",function(value)
...
S:Toggle("Auto Buy Abilities",  function(t)
    Abilities = t
...
spawn(function()
    ...
    D:Toggle("Fruit Notification",_G.Grabfruit,function(value)
    _G.FruitCheck = value
    end)
...
repeat wait() until game:IsLoaded() 
	...
	Misc:Toggle("Lock Level",function(value)
		_G.LockLevel = value
	end)
...
Misc:Slider("Select Level Lock Farm",1,LockLevelValue,LockLevelValue,nil,function(value)
	...
	Misc:Toggle("Lock Beli",function(value)
		_G.LockBeli = value
	end)
	...
	Misc:Toggle("Lock Fragments",function(value)
	...
	Misc:Toggle("Lock Bone",function(vv)
		_G.Open_LockBone = vv
	end)
