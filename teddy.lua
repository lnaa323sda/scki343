...
Tab2:AddButton({
    ...
    Callback = function()
        wait(1) loadstring(game:HttpGet("https://raw.githubusercontent.com/shinichi-dz/shinhop/refs/heads/main/soulreaper.lua%20(1).txt"))()  -- Link Discord invite của bạn
        game.StarterGui:SetCore(
            "SendNotification",
            {
                Title = "Zush Hub",
...
local MirageIslandStatus = "❌"
if game.Workspace._WorldOrigin.Locations:FindFirstChild('Mirage Island') then
    MirageIslandStatus = "🟢"
end

local FrozenIslandStatus = "❌"
if game.Workspace._WorldOrigin.Locations:FindFirstChild('Frozen Dimension') then
    FrozenIslandStatus = "Spawning 🟢"
end

local SwordStatus = "Không có kiếm"
	...
	["embeds"] = {
		{
			...
			["fields"] = {
				...
				{
					["name"] = "⚔️ Legend Swords:",
					["value"] = "```" .. SwordStatus .. "```",
					["inline"] = true
				},
				{
					["name"] = "🦅 Katakuri Status:",
