...
do local GUI = game.CoreGui:FindFirstChild("DucV4Hub");if GUI then GUI:Destroy();end;if _G.Color == nil then
...
game.StarterGui:SetCore("SendNotification", {
  Title = "DucV4 Hub"; -- the title (ofc)
  Text = text; -- what the text says (ofc)
  Icon = "rbxassetid://18794802606"; -- the image if u want.
...
Top.ZIndex = 2
	...
	Logo.Image = "rbxassetid://18794802606"
	Logo.Active = true
	Logo.ZIndex = 8
