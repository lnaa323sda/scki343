...
-- theme
local _KAITUN_THEME_URL = "https://raw.githubusercontent.com/lnaa323sda/scki343/refs/heads/main/theme.lua"
pcall(function()
...
_G.Config = {
    ...
    FpsBoost        = true,     -- BlackScreen ลดแลค — เปิด/ปิดแค่ true/false ตรงนี้ (ไม่มีปุ่ม)
...
-- Black Screen (FPS Boost) — chỉ theo _G.Config.FpsBoost (true/false)
